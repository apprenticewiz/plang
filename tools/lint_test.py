...
BRACE_CHECK_EXEMPT = {
    ...
    # '{$I+}'/'{$I-}' (and, in the two gap-fix files just below -- formerly
    # the two known-gap files, renamed once the gap they pinned was fixed --
    # a quoted `{$mode tp}` from a real `fpc -Mtp` repro session) syntax in

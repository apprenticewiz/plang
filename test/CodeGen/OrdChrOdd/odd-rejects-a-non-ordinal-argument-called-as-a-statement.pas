...
ord-rejects-a-non-ordinal-argument-called-as-a-statement.pas -- odd shares
the exact same checkCallStmt gap ord does.  Before the fix, odd(1.5) called
...
uncaught (odd's own lowering did not happen to crash the way ord's did, so

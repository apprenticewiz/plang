...
// PlangTimeStamp is declared in plang/Basic/RequiredRecordLayouts.h, which
// codegen reads as well: timestampStructType() checks the LLVM type it
// builds against this struct field by field, so the two encodings of one
// layout can no longer drift apart.
